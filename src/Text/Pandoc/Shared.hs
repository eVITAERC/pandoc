...
normalizeBlocks (Table capt aligns widths hdrs rows : xs) =
  ...
  : normalizeBlocks xs
normalizeBlocks (ImageGrid imgs : xs) =
  ImageGrid (map normalizeInlines imgs) : normalizeBlocks xs
normalizeBlocks (Figure typ attr content pc capt : xs) =
  Figure typ attr (normalizeBlocks content) pc (normalizeInlines capt)
  : normalizeBlocks xs
